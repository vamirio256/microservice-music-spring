...
const MediaControl = (props) => {
  ...
  return (
    <div className="fixed bg-[color:var(--media-control-bg)] z-[300] flex w-full shadow-[0px_-0.2px_5px_0px_rgba(0,0,0,0.75)] h-[90px] bottom-0">
      <audio
        src={currentSong.url}
        ref={audio_ref}
      ...
      <div className="relative flex justify-between w-full pl-[220px]">
        {/* media info */}
