      ...
      {tracks.length != 0 ? (
        ...
        <div className="h-2/3 w-full flex justify-center items-center flex-col">
          ...
          {currentUser.id !== user.id ? (
            ...
            <>
              <h2 className="mt-6 mb-2 text-[18px]">Seem a little quiet over here</h2>
              <p className="text-[#38d] text-sm font-extralight mb-3">Upload a track to share it with your followers.</p>
